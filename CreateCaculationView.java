...
import com.sap.hana.cvapi.bimodel.cube.CalculatedMeasures;
import com.sap.hana.cvapi.bimodel.cube.MeasureGroup;
import com.sap.hana.cvapi.bimodel.cube.MeasureType;
import com.sap.hana.cvapi.bimodel.cube.RestrictedMeasures;
...
import com.sap.hana.cvapi.bimodel.variable.LocalVariables;
...
public class CreateCaculationView {
	private static final String CAL_SCENARIO_ID = "performanceAnalysisByJava";
	private static final String JOIN_ID = "ID";

	private static final String PERFORMANCE_TABLE = "hana_cloud_demo.db.data::PERFORMANCE";
	private static final String SALARY_TABLE = "hana_cloud_demo.db.data::SALARY";
	...
	private static final String SALARY_PROJ_NAME = "hana_cloud_demo.db.data::SALARY";
	private static final String PERFORMANCE_PROJ_NAME = "hana_cloud_demo.db.data::PERFORMANCE";
    ...
    logicalModel.setCalculatedMeasures(new CalculatedMeasures());
    logicalModel.setRestrictedMeasures(new RestrictedMeasures());
    ...
    calcScenario.setLocalVariables(new LocalVariables());
